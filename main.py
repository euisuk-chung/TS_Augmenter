...
file_name = 'netis'
# args.scale_type = 'MinMax' # 'Standard' or 'MinMax' or 'Robust'
args.undo = False

TRAIN_DF, TEST_DF, TRAIN_SCALED, TEST_SCALED, cols, scaler = load_data(file_name = file_name, scale_type = args.scale_type)
...
# SAVE MODEL
vrae.save(f'VRAE_{args.scale_type}_hidden_{args.hidden_layer_depth}_win_{args.sequence_length}.pth')
print(f'>>>> SAVED VRAE_{args.scale_type}_hidden_{args.hidden_layer_depth}_win_{args.sequence_length}')
...
with open(f'./result/{args.scale_type}_un_{args.undo}_hl_{args.hidden_layer_depth}_win_{args.sequence_length}.pkl', 'wb') as f:
